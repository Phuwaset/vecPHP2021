    ...
    <div class="row">
        ...
        <div class="col">
            ...
            <form action="" enctype="multipart/form-data" method="post">
                ...
                <br>
                <input type="submit" name="update_rs" class="btn btn-danger form-control" value="เเก้ไขข้อมูล">
            </form>
        </div>
        <div class="col"></div>
    </div>
    ...
    <div class="row">
        ...
        <div class="col">
            ...
            <form action="" enctype="multipart/form-data" method="post">
                ...
                <br>
                <input type="submit" name="update_img" class="btn btn-danger form-control" value="เเก้ไขรูปภาพ">
            </form>
        </div>
        <div class="col"></div>
        <div style="height:5vh;"></div>
