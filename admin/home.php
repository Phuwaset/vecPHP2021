       ...
       <div class="container-fluid">
           ...
           <div class="collapse navbar-collapse" id="navbarNav">
               <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                   ...
                   <li class="nav-items">
                       <a href="?page=report" class="nav-link active" >รายงานผู้ใช้งานระบบ</a>
                   </li>
                   <li class="nav-items">
                       <a href="?page=accept" class="nav-link active" >อนุมัติผู้ใช้งานระบบ</a>
                   </li>
               </ul>
   ...
   <div class="container">
        <?php 
            ...
            switch($page){
                ...
                case 'accept' : include('accept.php');break;
                case 'edit_profile' : include('edit_profile.php');break;
                case 'logout' : include('logout.php');break;
                case 'edit_feed' : include('edit_feed.php');break;
                case 'delete_feed' : include('delete_feed.php');break;
                default : include('feed.php');
            }
        ?>
   </div>
