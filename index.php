<?php 
    ...
    if(isset($_POST['login'])){
        ...
        if($row['user_id']!=''){
            if($row['user_status'] == '1' and $row['user_status'] !='9'){
                $_SESSION['ID'] = $row['user_id'];
                header('location:user/home.php');
            }else{
                echo "<script>alert('ยังไม่ได้รับอนุญาตจากผู้ดูเเลระบบ')</script>";
            }
        }
    }
?>
    ...
    <section class="Form my-4 mx-5">
        <div class="container">
            <div class="row g-0">
                ...
                <center><h3 class="font-weight-bold py-3"><b><span>ยินดีต้อนรับ </span>ผู้ใช้งานระบบ</b><hr></h3>
                ...
                <form action="" enctype="multipart/form-data" class="align-self-center" method="post">
                    ...
                    <div class="form-row">
                        <div class="col-lg-7">
                            <button class="btn1 mt-3 mb-5 btn-primary" type="submit" name="login">เข้าสู่ระบบ</button>
                        </div>
                    </div>
                </form>
                <p><b>ยังไม่ได้ลงทะเบียนใช่หรือไม่ <a href="register.php">ลงทะเบียน</a></b></p>
                <p>สำหรับผู้ดูเเลระบบ <a href="admin/index.php">คลิก</a></p>
                </div>
            </div>
        </div>
    </section>
